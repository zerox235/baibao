...
@Ignore
public class ZhipuAIActionTest {
    private static final Logger log = LoggerFactory.getLogger(ZhipuAIActionTest.class);
    ...
    static {
        ...
        ActionUtils.registerAction(handlerName, new AbstractZhipuAIAction() {
            @Override
